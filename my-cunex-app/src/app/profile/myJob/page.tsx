  ...
  return (
    <div className="bg-gray-100 min-h-screen pb-20">
      ...
      <div className="bg-white flex mb-4 shadow-sm">
        <button 
          className={`flex-1 py-3 text-center font-medium ${activeTab === 'ongoing' ? 'text-pink-500 border-b-2 border-pink-500' : 'text-gray-500'}`}
          onClick={() => setActiveTab('ongoing')}
        >
          Ongoing
        </button>
        <button 
          className={`flex-1 py-3 text-center font-medium ${activeTab === 'completed' ? 'text-pink-500 border-b-2 border-pink-500' : 'text-gray-500'}`}
      ...
      <div className="mx-4">
        {activeTab === 'ongoing' && (
          <>
            {ongoingJobs.map(job => (
              <div key={job.id} className="bg-white rounded-lg shadow-sm mb-4 overflow-hidden">
                <div className="p-4">
                  ...
                  <p className="text-gray-500 text-sm mb-1">Client: {job.client}</p>
              ...
              <div key={job.id} className="bg-white rounded-lg shadow-sm mb-4 overflow-hidden">
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center mb-2">
                    <p className="text-gray-500 text-sm">Completed: {job.completedDate}</p>
                    <div className="flex items-center">
