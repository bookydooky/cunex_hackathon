...
const WorkAbout = () => {
  ...
  <div className="p-4">
    ...
    <div className="text-right">
      <a href="#" className="text-Pink text-sm hover:underline hover:underline-offset-1">View Full Profile</a>
    </div>
    ...
    <div className="flex items-center mt-2 mb-4">
      ...
      <div className="ml-6">
        <h2 className="text-2xl text-Gray font-bold">Maria Schmidt</h2>
    ...
    <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div className="bg-pink-50 p-4 rounded-lg">
              <div className="flex items-center text-Pink mb-1">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" className="mr-2 text-Pink">
